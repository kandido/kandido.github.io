...
### gcc -m32 -o sum1toN_v6 sum1toN_v6.s
### Ensamblaje as --32  -o sum1toN_v6.o  sum1toN_v6.s
### linker -> ld  -e main -melf_i386 -I/lib/i386-linux-gnu/ld-linux.so.2  -o  sum1toN_v6  sum1toN_v6.o -lc
