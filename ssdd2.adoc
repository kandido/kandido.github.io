...
. Estados del sistema
** Memoria
** Número de biestables ->4 estados -> 2 bits -> 2 biestables -> variables Q1-Q0
** Códigos Q1Q0-> 00 (PB), 01 (SUB), 10 (BAJ) y  11 (PA)
. Salidas del sistema
** Número de bits -> 3 salidas -> 2 bits -> variables Z1-Z0
** Códigos Z1Z0 -> 00 (MP), 01 (MS) y 10 (MB)
...
* Diagrama tipo MOORE: las salidas únicamente dependen del estado de la máquina digital.
* Representar los estados con círculos y la salida del sistema correspondiente.
* Representar las transiciones entre estados con Flechas y la entrada de sistema asociada.
