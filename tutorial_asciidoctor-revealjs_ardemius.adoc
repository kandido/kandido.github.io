...
[background-iframe="https://www.youtube.com/embed/U09ID0wNdyw?rel=0&start=3&enablejsapi=1&autoplay=1&loop=1&controls=0&modestbranding=1"]
//video::U09ID0wNdyw[youtube, start=34, options=autoplay]
== Nice background 1!

// Background videos
[background-video="http://techslides.com/demos/sample-videos/small.mp4",background-opacity=0.4]
//,background-video-loop=true,background-video-muted=true,title-slide-background-opacity=0.4
== Nice background 2!
...
== Stack: Apilar elementos (horizontal,vertical, top)
