...
= (x+y+z)(x+y+\overline z)(x+\overline y+\overline z)(\overline x+\overline y+\overline z)=M_7M_6M_4M_0
]
...
*** DK : definición libre para simplificar
* Ejercicio 1.4
** Resolverlo por DK
...
[source,vhdl]
--
-- Sistemas Digitales : Descripción VHDL Curso 2023
-- Circuito light: Puerta lógica XOR
entity of light is
  port (
    x,y : in bit;
    z   : out bit
...
* tipo de dato secuencia de bits: "010001010101" -> entrecomillado.
